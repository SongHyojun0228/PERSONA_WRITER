...
BEGIN
    ...
    -- ====================================
    -- 2. 마법사의 귀환 (판타지, 유료 300원)
    -- ====================================
    INSERT INTO published_stories (user_id, title, content, cover_image_url, genre, description, is_paid, price, view_count)
    VALUES (
        v_user_id,
        '마법사의 귀환',
        '<h1>프롤로그. 봉인의 끝</h1><p>어둠 속에서 눈을 떴다. 얼마나 잠들어 있었던 걸까. 아르카디우스는 천천히 몸을 일으켰다. 봉인의 마력이 완전히 풀린 것이 느껴졌다. 그는 주변을 둘러보았다. 한때 그가 지배하던 마법탑은 이제 폐허가 되어 있었다.</p><p>"천년... 천년이나 지났단 말인가." 그의 목소리는 쉬어 있었다. 봉인되기 전, 그는 세계 최강의 대마법사였다. 하지만 동료들의 배신으로 이곳에 갇혀 긴 잠에 빠졌다. 이제 봉인이 풀렸지만, 그의 마나는 거의 바닥났고 몸은 예전 같지 않았다.</p><p>탑의 밖으로 나오자 낯선 풍경이 펼쳐졌다. 마법이 사라진 세계. 과학이라는 새로운 힘이 세상을 지배하고 있었다. 아르카디우스는 주먹을 쥐었다. "다시 시작이군. 좋아, 이번에는 내가 원하는 대로 이 세계를 만들어가겠어."</p><p>그렇게 천년 만에 깨어난 대마법사의 귀환이 시작되었다.</p><hr style="border-top: 2px dashed #bbb; margin: 2rem 0;" /><h1>1장. 새로운 세계</h1><p>아르카디우스는 가까운 마을로 향했다. 천년 전에는 작은 농촌 마을이었던 곳이 이제는 거대한 도시로 변해 있었다. 높은 건물들, 빛나는 간판들, 쉴 새 없이 달리는 자동차들. 모든 것이 낯설었다.</p><p>"저기, 할아버지 괜찮으세요?" 한 젊은 여성이 그에게 다가왔다. 그녀는 아르카디우스의 낡은 로브를 보며 걱정스러운 표정을 지었다. "코스프레... 하시는 건가요? 아니면 노숙자...?" 아르카디우스는 어리둥절했다. 코스프레? 노숙자? 이게 무슨 말인가.</p><p>"나는 대마법사 아르카디우스다. 이 세계를 지배하던..." 그가 말을 시작하자 여성은 웃으며 말을 끊었다. "아, RPG 게임 캐릭터 컨셉이시구나! 재밌네요. 근데 정말 추워 보여요. 여기 카페 가서 따뜻한 커피라도 드릴게요." 그녀는 그를 끌고 근처 카페로 향했다.</p><p>카페에 앉은 아르카디우스는 처음 보는 기계들과 음료에 놀랐다. "이게 뭐지?" "커피예요. 마셔보세요." 그는 조심스럽게 한 모금 마셨다. "음... 쓰지만 나쁘지 않군." 여성은 미소를 지으며 자기소개를 했다. "저는 이지은이에요. 직업은 마법사... 아니 웹 개발자고요." 아르카디우스는 이 이상한 세계에 적응해야 한다는 걸 깨달았다.</p><hr style="border-top: 2px dashed #bbb; margin: 2rem 0;" /><h1>2장. 숨겨진 마나</h1><p>며칠 후, 아르카디우스는 지은의 도움으로 임시 거처를 마련했다. 그녀는 그를 진짜 할아버지처럼 돌봐주었다. 하지만 그는 여전히 자신의 정체를 밝히지 못했다. 누가 믿겠는가, 천년 전 대마법사라는 것을.</p><p>어느 날 밤, 그는 도시를 배회하다 이상한 기운을 느꼈다. "이것은... 마나?" 희미하지만 분명한 마법의 흔적이었다. 그는 기운을 따라 오래된 골목길로 들어갔다. 거기서 그는 검은 로브를 입은 사람들이 수상한 의식을 치르는 것을 목격했다.</p><p>"어둠의 군주여, 이 세계에 강림하소서!" 그들이 외치자 마법진이 빛을 발했다. 아르카디우스는 경악했다. "이 멍청한 것들이! 어둠의 군주를 소환하다니!" 그는 즉시 마나를 모아 마법진을 파괴했다. 하지만 그의 약해진 마나로는 부족했고, 소환이 거의 완성되려는 순간이었다.</p><p>"막아야 해!" 그가 최후의 수단으로 금지된 마법을 시전하려는 순간, 갑자기 누군가가 나타나 마법진을 완전히 파괴했다. "누구냐!" 아르카디우스가 소리쳤다. 어둠 속에서 나타난 것은 놀랍게도... 지은이었다. 그녀의 손에서 빛나는 마법이 보였다. "지은... 너도 마법사였단 말이냐?" 그녀는 쓴웃음을 지으며 답했다. "비밀이 들켰네요, 아르카디우스님. 아니, 전설의 대마법사님."</p>',
        'https://images.unsplash.com/photo-1518398046578-8cca57782e17?w=800',
        '판타지',
        '천년 만에 봉인에서 깨어난 대마법사 아르카디우스. 마법이 사라진 현대 세계에서 다시 일어서는 그의 장대한 모험이 시작됩니다.',
        true,
        300,
        243
    );
    ...
    -- ====================================
    -- 8. 13호실의 저주 (미스터리, 유료 450원)
    -- ====================================
    INSERT INTO published_stories (user_id, title, content, cover_image_url, genre, description, is_paid, price, view_count)
    VALUES (
        v_user_id,
        '13호실의 저주',
        '<h1>1장. 여관 도착</h1><p>깊은 산속에 자리한 낡은 여관. 대학생 MT를 온 우리는 이곳밖에 예약할 곳이 없었다. "여기... 진짜 괜찮은 거야?" 친구 민수가 불안한 목소리로 물었다. 여관은 낡고 으스스했다.</p><p>"어서 오세요." 여관 주인은 60대 정도 되어 보이는 할머니였다. 그녀는 창백한 얼굴로 우리를 맞이했다. "방은 12호실까지 있습니다. 13호실은... 절대 들어가지 마세요." 할머니의 경고에 우리는 서로를 쳐다봤다.</p><p>"왜요?" 내가 물었다. 할머니는 고개를 저었다. "20년 전, 그 방에서 끔찍한 일이 있었어요. 그 이후로 그 방에 들어간 사람은... 모두..." 할머니는 말을 잇지 못했다. 우리는 등골이 서늘해지는 것을 느꼈다.</p><p>그날 밤, 복도 끝의 13호실 문에서 이상한 소리가 들렸다. 쿵... 쿵... 마치 누군가 문을 두드리는 것 같았다. "너희도 들었어?" 민수가 떨리는 목소리로 물었다. 우리는 고개를 끄덕였다. 호기심과 두려움 사이에서 우리는 결정을 내려야 했다. 13호실의 비밀을 밝혀낼 것인가, 아니면 모른 척 할 것인가.</p><hr style="border-top: 2px dashed #bbb; margin: 2rem 0;" /><h1>2장. 금기를 어기다</h1><p>결국 우리는 13호실을 조사하기로 했다. 할머니가 잠든 깊은 밤, 우리는 손전등을 들고 복도를 걸었다. 13호실 앞에 서자 차가운 기운이 느껴졌다. "진짜 들어갈 거야?" 민수가 물었다.</p><p>"여기까지 왔는데 포기할 순 없지." 나는 문손잡이를 잡았다. 놀랍게도 문은 잠기지 않았다. 끼익... 문이 열리며 오래된 먼지 냄새가 코를 찔렀다. 방 안은 완전히 비어 있었다. 가구도 없고, 창문도 막혀 있었다.</p><p>"별거 없잖아." 민수가 안도의 한숨을 쉬었다. 그때였다. 갑자기 문이 쾅 하고 닫혔다. "뭐야!" 우리는 놀라서 문으로 달려갔지만 문은 꿈쩍도 하지 않았다. 손전등이 깜빡이기 시작했고, 방 안 온도가 급격히 떨어졌다.</p><p>어둠 속에서 무언가가 움직이는 소리가 들렸다. "누, 누구세요?" 내가 떨리는 목소리로 물었다. 그때 창문에 비친 그림자가 보였다. 길게 늘어진 머리카락, 하얀 옷을 입은 여자의 형상. 그녀가 천천히 우리를 향해 다가왔다. "나가... 나가..." 귀에서 속삭이는 목소리가 들렸다. 우리는 비명을 지르며 문을 두들겼다.</p>',
        'https://images.unsplash.com/photo-1509248961158-e54f6934749c?w=800',
        '미스터리',
        '산속 여관의 금기된 방 13호실. 호기심에 이끌린 대학생들이 마주한 공포와 20년 전 억울한 죽음의 진실을 파헤치는 공포 미스터리.',
        true,
        450,
        423
    );
